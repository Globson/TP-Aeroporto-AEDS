...
void Inicializa_Item_Matriz(TItem_Matriz* pI_Matriz){
  ...
  strcpy(pI_Matriz->Hora_Ultima_Atualizacao,"");}
//------------------------------------------------------------------------------------------------------
//SETS
...
void SetUltima_Atualizacao(TItem_Matriz* pI_Matriz){ //Entra com o ponteiro para o Item Matriz o qual vc quer inserir o inteiro Ultima_Atualizacao.//
  ...
  strcpy(pI_Matriz->Hora_Ultima_Atualizacao,ctime(&timer));}
  //------------------------------------------------------------------------------------------------------
  //GETS
  ...
  char*  GetUltima_Atualizacao(TItem_Matriz* pI_Matriz){//Essa função retorna o ponteiro char da hora da Ultima Atualização do *Item Matriz passado por parametro.//
